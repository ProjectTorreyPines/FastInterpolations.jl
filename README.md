...
> **Pkg:** FastInterpolations (v0.4.3) · Interpolations (v0.16.2) · DataInterpolations (v8.9.0) · Dierckx (v0.5.4)
<!-- BENCHMARK_VERSIONS_END -->

![One-Shot](docs/images/benchmark_oneshot_detail.png)

<!-- BENCHMARK_SPEEDUP_START -->
**Speedup:** (2.1 ~ 15.4)× vs `Interpolations.jl` · (8.8 ~ 22.2)× vs `DataInterpolations.jl` · (14.6 ~ 18.2)× vs `Dierckx.jl`

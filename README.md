...
sitp = cubic_interp(x, Series(y1, y2, y3, y4))   # create SeriesInterpolant
...
> **Pkg:** FastInterpolations (v0.3.1) · Interpolations (v0.16.2) · DataInterpolations (v8.9.0) · Dierckx (v0.5.4)
<!-- BENCHMARK_VERSIONS_END -->

![One-Shot](docs/images/benchmark_oneshot_detail.png)

<!-- BENCHMARK_SPEEDUP_START -->
**Speedup:** (2.2 ~ 14.5)× vs `Interpolations.jl` · (8.3 ~ 22.6)× vs `DataInterpolations.jl` · (14.0 ~ 18.7)× vs `Dierckx.jl`

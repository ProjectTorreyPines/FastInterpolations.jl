![Banner](docs/images/FastInterpolations_banner.png)
...
> **Pkg:** FastInterpolations (v0.2.10) · Interpolations (v0.16.2) · DataInterpolations (v8.9.0) · Dierckx (v0.5.4)
<!-- BENCHMARK_VERSIONS_END -->

![One-Shot](docs/images/benchmark_oneshot_detail.png)

<!-- BENCHMARK_SPEEDUP_START -->
**Speedup:** (2.2 ~ 15.4)× vs `Interpolations.jl` · (8.8 ~ 22.7)× vs `DataInterpolations.jl` · (14.8 ~ 18.6)× vs `Dierckx.jl`

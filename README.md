...
> **Pkg:** FastInterpolations (v0.4.12) · Interpolations (v0.16.2) · DataInterpolations (v8.10.0) · Dierckx (v0.5.4)
<!-- BENCHMARK_VERSIONS_END -->

![One-Shot](docs/images/benchmark_oneshot_detail.png)

<!-- BENCHMARK_SPEEDUP_START -->
**Speedup:** (2.4 ~ 16.0)× vs `Interpolations.jl` · (9.7 ~ 24.0)× vs `DataInterpolations.jl` · (14.9 ~ 19.5)× vs `Dierckx.jl`

...
> **Pkg:** FastInterpolations (v0.2.9) · Interpolations (v0.16.2) · DataInterpolations (v8.9.0) · Dierckx (v0.5.4)
<!-- BENCHMARK_VERSIONS_END -->

![One-Shot](docs/images/benchmark_oneshot_detail.png)

<!-- BENCHMARK_SPEEDUP_START -->
**Speedup:** (2.2 ~ 15.9)× vs `Interpolations.jl` · (9.1 ~ 22.7)× vs `DataInterpolations.jl` · (14.5 ~ 18.5)× vs `Dierckx.jl`

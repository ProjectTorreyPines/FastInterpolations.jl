...
> **Pkg:** FastInterpolations (v0.4.13) · Interpolations (v0.16.3) · DataInterpolations (v8.10.0) · Dierckx (v0.5.4)
<!-- BENCHMARK_VERSIONS_END -->

![One-Shot](docs/images/benchmark_oneshot_detail.png)

<!-- BENCHMARK_SPEEDUP_START -->
**Speedup:** (2.4 ~ 16.0)× vs `Interpolations.jl` · (9.6 ~ 24.0)× vs `DataInterpolations.jl` · (14.6 ~ 19.5)× vs `Dierckx.jl`

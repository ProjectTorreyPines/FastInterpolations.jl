...
> **Pkg:** FastInterpolations (v0.4.17) · Interpolations (v0.16.3) · DataInterpolations (v9.0.2) · Dierckx (v0.5.4)
<!-- BENCHMARK_VERSIONS_END -->

![One-Shot](docs/images/benchmark_oneshot_detail.png)

<!-- BENCHMARK_SPEEDUP_START -->
**Speedup:** (2.4 ~ 15.8)× vs `Interpolations.jl` · (2.8 ~ 9.1)× vs `DataInterpolations.jl` · (14.5 ~ 19.8)× vs `Dierckx.jl`

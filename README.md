...
> **Pkg:** FastInterpolations (v0.2.12) · Interpolations (v0.16.2) · DataInterpolations (v8.9.0) · Dierckx (v0.5.4)
<!-- BENCHMARK_VERSIONS_END -->

![One-Shot](docs/images/benchmark_oneshot_detail.png)

<!-- BENCHMARK_SPEEDUP_START -->
**Speedup:** (2.2 ~ 15.5)× vs `Interpolations.jl` · (8.7 ~ 22.6)× vs `DataInterpolations.jl` · (14.8 ~ 18.7)× vs `Dierckx.jl`

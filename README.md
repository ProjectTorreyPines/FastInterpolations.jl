...
> **Pkg:** FastInterpolations (v0.4.0) · Interpolations (v0.16.2) · DataInterpolations (v8.9.0) · Dierckx (v0.5.4)
<!-- BENCHMARK_VERSIONS_END -->

![One-Shot](docs/images/benchmark_oneshot_detail.png)

<!-- BENCHMARK_SPEEDUP_START -->
**Speedup:** (2.2 ~ 15.8)× vs `Interpolations.jl` · (9.0 ~ 22.6)× vs `DataInterpolations.jl` · (15.0 ~ 18.9)× vs `Dierckx.jl`
...
```julia
cubic_interp(x, y; extrap=Extrap(:clamped))             # clamp to boundary value

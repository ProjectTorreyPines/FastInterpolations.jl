...
Benchmark comparison against [Interpolations.jl](https://github.com/JuliaMath/Interpolations.jl) and [DataInterpolations.jl](https://github.com/SciML/DataInterpolations.jl) for **cubic spline interpolation**. See [https://github.com/ProjectTorreyPines/FastInterpolations.jl/blob/master/benchmark/](https://github.com/ProjectTorreyPines/FastInterpolations.jl/blob/master/benchmark/) for full results.

![One-Shot](images/benchmark_oneshot_detail.png)

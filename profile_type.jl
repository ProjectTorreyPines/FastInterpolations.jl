...
println("--- _phs_eval_blended ---")
@code_warntype FastInterpolations._phs_eval_blended(itp, (0.5, 0.5, 0.5), ops_val)

println("\n--- _phs_eval_stencil ---")
rhs_buf = zeros(Float64, 60)
coeff_buf = zeros(Float64, 60)
@code_warntype FastInterpolations._phs_eval_stencil(itp, (10, 10, 10), (0.5, 0.5, 0.5), ops_val, rhs_buf, coeff_buf)

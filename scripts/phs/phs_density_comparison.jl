...
const OUT_PATH = normpath(joinpath(@__DIR__, "..", "..", "docs", "images", "phs_density_comparison.png"))
...
time_cardinal = @elapsed itp_cardinal = interp(
    grids, rho_3d;

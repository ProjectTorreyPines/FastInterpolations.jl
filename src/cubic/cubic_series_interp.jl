...
"""
    cubic_interp(x, ys::AbstractVector{<:AbstractVector}; bc=ZeroCurvBC(), extrap=NoExtrap(), autocache=true, precompute_transpose=false)
...
- `bc`: Boundary condition (ZeroCurvBC, ZeroSlopeBC, PeriodicBC, or Vector of BC for per-series)
...
function cubic_interp(
    ...
    bc::Union{AbstractBC, AbstractVector{<:AbstractBC}}=ZeroCurvBC(),
...
"""
    cubic_interp(x, Y::AbstractMatrix; bc=ZeroCurvBC(), extrap=NoExtrap(), autocache=true, precompute_transpose=false)

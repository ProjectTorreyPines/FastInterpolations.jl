...
# ========================================
# Callable methods for HermiteInterpolant1D and interpolant-form API.
...
@inline function HermiteInterpolant1D(
        x::X,
        y::Y,
        dy::DY;
    ...
    S = typeof(spacing)
    return HermiteInterpolant1D{Tg, Tv, X, Y, DY, S, E, P}(
...
"""
    hermite_interp(x, y, dy; extrap=NoExtrap(), search=AutoSearch()) -> HermiteInterpolant1D
...
# Returns
`HermiteInterpolant1D` callable object. Supports:
- Scalar: `itp(0.5)`
- Vector: `itp(xq_vec)`

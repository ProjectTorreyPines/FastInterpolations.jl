...
@inline @with_pool pool function quadratic_interp(
    ...
    A_lean = _quadratic_series_anchor_type(
        deriv, extrap, x, _coord_eltype(Tq, eltype(x))
    )
...
@with_pool pool function quadratic_interp!(
    ...
    A_lean = _quadratic_series_anchor_type(
        deriv, extrap_eff, x, _coord_eltype(Tq, Tg_actual)
    )
...
function quadratic_interp(
    ...
    Tv_out = _deriv_eltype(
        _promote_eltype(_interp_op, Tg_float, _series_eltype(s), Tq),
        Tg_float,
        deriv
    )

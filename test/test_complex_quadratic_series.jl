# ========================================
# Complex Quadratic Series Interpolation Tests
# ========================================
# Tests for native Complex number support in QuadraticSeriesInterpolant.
# Validates the Tg/Tv type separation design for series interpolants.

@testitem "Complex Quadratic Series Interpolation" setup = [AllocConstants] begin
    ...
    @testset "Derivative for Complex values" begin
        x = range(0.0, 1.0, 21)
        # Quadratic complex function: y = (1+2i)*x^2 + (2-1i)*x + (3+1i)
    ...
    # ========================================
    # Complex Quadratic Function Accuracy
    # ========================================
    @testset "Complex quadratic function accuracy" begin
        # Test that quadratic interpolation exactly fits a quadratic function
